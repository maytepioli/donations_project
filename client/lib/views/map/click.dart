...
const CameraPosition _posicionInicial =
  CameraPosition(target: LatLng(-34.903280, -56.188160), 
  zoom: 11.0
  );

class ClickPagina extends Pagina {
  const ClickPagina() : super(const Icon(Icons.mouse), 'Clicks');
...
class _ClickState extends State<Click> {
  ...
  void onMapCreated(GoogleMapController controllerMap) async {
    setState(() {
